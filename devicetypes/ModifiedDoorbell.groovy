...
metadata {
	...
	definition (name: "Edited Ecolink Doorbell Sensor v4", namespace: "jscgs350", author: "SmartThings") {
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"contact", type: "lighting", width: 6, height: 4, canChangeIcon: true){
			tileAttribute ("device.contact", key: "PRIMARY_CONTROL") {
				...
				attributeState "closed", label: "Silent", icon: "st.Home.home30", backgroundColor: "#C6C7CC"
			}
